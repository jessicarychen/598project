package org.apache.spark.streaming.ui;
  ...
  private  scala.collection.Seq<scala.xml.Node> generateJobRow (org.apache.spark.streaming.ui.OutputOperationUIData outputOpData, scala.collection.Seq<scala.xml.Node> outputOpDescription, java.lang.String formattedOutputOpDuration, int numSparkJobRowsInOutputOp, boolean isFirstRow, org.apache.spark.streaming.ui.SparkJobIdWithUIData jobIdWithData)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  scala.collection.Seq<scala.xml.Node> generateNormalJobRow (org.apache.spark.streaming.ui.OutputOperationUIData outputOpData, scala.collection.Seq<scala.xml.Node> outputOpDescription, java.lang.String formattedOutputOpDuration, int numSparkJobRowsInOutputOp, boolean isFirstRow, org.apache.spark.status.api.v1.JobData sparkJob)  { throw new RuntimeException(); }
  /**
