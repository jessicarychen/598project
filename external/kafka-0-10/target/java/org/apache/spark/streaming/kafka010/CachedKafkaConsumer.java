 ...
 */
  ...
  protected  java.util.ListIterator<org.apache.kafka.clients.consumer.ConsumerRecord<K, V>> buffer ()  { throw new RuntimeException(); }
   ...
   * @param timeout (undocumented)
   */
  public  void compactedStart (long offset, long timeout)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.kafka.clients.consumer.ConsumerRecord<K, V> compactedNext (long timeout)  { throw new RuntimeException(); }
  /**
