 ...
 */
  ...
  private  void cleanAppData (java.lang.String appId, scala.Option<java.lang.String> attemptId, java.lang.String logPath)  { throw new RuntimeException(); }
    long getNewLastScanTime ()  { throw new RuntimeException(); }
   ...
   */
  protected  void mergeApplicationListing (org.apache.hadoop.fs.FileStatus fileStatus, long scanTime)  { throw new RuntimeException(); }
  /**
   * Delete event logs from the log directory according to the clean policy defined by the user.
   */
    void cleanLogs ()  { throw new RuntimeException(); }
  /**
   * Replays the events in the specified log file on the supplied <code>ReplayListenerBus</code>.
   * <code>ReplayEventsFilter</code> determines what events are replayed.
   * @param eventLog (undocumented)
   * @param bus (undocumented)
   * @param eventsFilter (undocumented)
   */
  private  void replay (org.apache.hadoop.fs.FileStatus eventLog, org.apache.spark.scheduler.ReplayListenerBus bus, scala.Function1<java.lang.String, java.lang.Object> eventsFilter)  { throw new RuntimeException(); }
  /**
