 ...
 */
  ...
  static public  org.apache.spark.api.python.PythonRunner apply (org.apache.spark.api.python.PythonFunction func, int bufferSize, boolean reuseWorker)  { throw new RuntimeException(); }
  ...
  public   PythonRunner (scala.collection.Seq<org.apache.spark.api.python.ChainedPythonFunctions> funcs, int bufferSize, boolean reuseWorker)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.Iterator<byte[]> newReaderIterator (java.io.DataInputStream stream, org.apache.spark.api.python.BasePythonRunner<byte[], byte[]>.WriterThread writerThread, long startTime, org.apache.spark.SparkEnv env, java.net.Socket worker, java.util.concurrent.atomic.AtomicBoolean released, org.apache.spark.TaskContext context)  { throw new RuntimeException(); }
}
