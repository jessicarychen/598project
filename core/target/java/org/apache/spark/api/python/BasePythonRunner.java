 ...
 */
 abstract class BasePythonRunner<IN extends java.lang.Object, OUT extends java.lang.Object> implements org.apache.spark.internal.Logging {
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  public   BasePythonRunner (scala.collection.Seq<org.apache.spark.api.python.ChainedPythonFunctions> funcs, int bufferSize, boolean reuseWorker, int evalType, int[][] argOffsets)  { throw new RuntimeException(); }
  ...
  protected abstract  scala.collection.Iterator<OUT> newReaderIterator (java.io.DataInputStream stream, org.apache.spark.api.python.BasePythonRunner<IN, OUT>.WriterThread writerThread, long startTime, org.apache.spark.SparkEnv env, java.net.Socket worker, java.util.concurrent.atomic.AtomicBoolean released, org.apache.spark.TaskContext context)  ;
  /**
  ...
  public abstract class ReaderIterator implements scala.collection.Iterator<OUT> {
    public   ReaderIterator (java.io.DataInputStream stream, org.apache.spark.api.python.BasePythonRunner<IN, OUT>.WriterThread writerThread, long startTime, org.apache.spark.SparkEnv env, java.net.Socket worker, java.util.concurrent.atomic.AtomicBoolean released, org.apache.spark.TaskContext context)  { throw new RuntimeException(); }
