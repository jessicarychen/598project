...
public  class Alias extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.NamedExpression, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   Alias (org.apache.spark.sql.catalyst.expressions.Expression child, java.lang.String name, org.apache.spark.sql.catalyst.expressions.ExprId exprId, scala.Option<java.lang.String> qualifier, scala.Option<org.apache.spark.sql.types.Metadata> explicitMetadata)  { throw new RuntimeException(); }
