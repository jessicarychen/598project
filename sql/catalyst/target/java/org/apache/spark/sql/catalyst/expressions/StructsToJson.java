...
/**
 * Converts a {@link StructType}, {@link ArrayType} of {@link StructType}s, {@link MapType}
 * or {@link ArrayType} of {@link MapType}s to a json output string.
 */
public  class StructsToJson extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.TimeZoneAwareExpression, org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, org.apache.spark.sql.catalyst.expressions.ExpectsInputTypes, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.types.DataType rowSchema ()  { throw new RuntimeException(); }
