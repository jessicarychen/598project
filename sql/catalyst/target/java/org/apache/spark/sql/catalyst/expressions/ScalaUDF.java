...
public  class ScalaUDF extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.ImplicitCastInputTypes, org.apache.spark.sql.catalyst.expressions.NonSQLExpression, org.apache.spark.sql.catalyst.expressions.UserDefinedExpression, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ScalaUDF (java.lang.Object function, org.apache.spark.sql.types.DataType dataType, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children, scala.collection.Seq<org.apache.spark.sql.types.DataType> inputTypes, scala.Option<java.lang.String> udfName, boolean nullable, boolean udfDeterministic)  { throw new RuntimeException(); }
