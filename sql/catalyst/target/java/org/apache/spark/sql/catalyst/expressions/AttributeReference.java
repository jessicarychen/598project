...
public  class AttributeReference extends org.apache.spark.sql.catalyst.expressions.Attribute implements org.apache.spark.sql.catalyst.expressions.Unevaluable, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AttributeReference (java.lang.String name, org.apache.spark.sql.types.DataType dataType, boolean nullable, org.apache.spark.sql.types.Metadata metadata, org.apache.spark.sql.catalyst.expressions.ExprId exprId, scala.Option<java.lang.String> qualifier)  { throw new RuntimeException(); }
  /**
