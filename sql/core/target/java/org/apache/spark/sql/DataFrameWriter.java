...
public final class DataFrameWriter<T extends java.lang.Object> {
   ...
   *   - <code>error</code> or <code>errorifexists</code>: default option, throw an exception at runtime.
   * <p>
   * @since 1.4.0
   * @param saveMode (undocumented)
   * @return (undocumented)
   ...
   * shorten names(<code>none</code>, <code>snappy</code>, <code>gzip</code>, and <code>lzo</code>). This will override
