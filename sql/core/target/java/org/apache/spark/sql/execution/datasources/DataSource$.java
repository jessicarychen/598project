...
public  class DataSource$ implements org.apache.spark.internal.Logging, scala.Serializable {
   ...
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.hadoop.fs.Path> checkAndGlobPathIfNecessary (org.apache.hadoop.conf.Configuration hadoopConf, java.lang.String path, boolean checkFilesExist)  { throw new RuntimeException(); }
}
