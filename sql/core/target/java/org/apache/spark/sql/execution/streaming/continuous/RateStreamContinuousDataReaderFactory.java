...
public  class RateStreamContinuousDataReaderFactory implements org.apache.spark.sql.sources.v2.reader.DataReaderFactory<org.apache.spark.sql.Row>, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   RateStreamContinuousDataReaderFactory (long startValue, long startTimeMs, int partitionIndex, long increment, double rowsPerSecond)  { throw new RuntimeException(); }
