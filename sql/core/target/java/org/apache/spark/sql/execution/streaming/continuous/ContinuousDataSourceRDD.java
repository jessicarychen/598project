...
public  class ContinuousDataSourceRDD extends org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.expressions.UnsafeRow> {
  static   org.apache.spark.sql.sources.v2.reader.streaming.ContinuousDataReader<?> getBaseReader (org.apache.spark.sql.sources.v2.reader.DataReader<org.apache.spark.sql.catalyst.expressions.UnsafeRow> reader)  { throw new RuntimeException(); }
  ...
  private  java.util.List<org.apache.spark.sql.sources.v2.reader.DataReaderFactory<org.apache.spark.sql.catalyst.expressions.UnsafeRow>> readerFactories ()  { throw new RuntimeException(); }
  // not preceding
  public   ContinuousDataSourceRDD (org.apache.spark.SparkContext sc, org.apache.spark.sql.SQLContext sqlContext, java.util.List<org.apache.spark.sql.sources.v2.reader.DataReaderFactory<org.apache.spark.sql.catalyst.expressions.UnsafeRow>> readerFactories)  { throw new RuntimeException(); }
  private  int dataQueueSize ()  { throw new RuntimeException(); }
  private  long epochPollIntervalMs ()  { throw new RuntimeException(); }
