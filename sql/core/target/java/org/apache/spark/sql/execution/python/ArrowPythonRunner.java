...
public  class ArrowPythonRunner extends org.apache.spark.api.python.BasePythonRunner<scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow>, org.apache.spark.sql.vectorized.ColumnarBatch> {
  public   ArrowPythonRunner (scala.collection.Seq<org.apache.spark.api.python.ChainedPythonFunctions> funcs, int bufferSize, boolean reuseWorker, int evalType, int[][] argOffsets, org.apache.spark.sql.types.StructType schema, java.lang.String timeZoneId, boolean respectTimeZone)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.Iterator<org.apache.spark.sql.vectorized.ColumnarBatch> newReaderIterator (java.io.DataInputStream stream, org.apache.spark.api.python.BasePythonRunner<scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow>, org.apache.spark.sql.vectorized.ColumnarBatch>.WriterThread writerThread, long startTime, org.apache.spark.SparkEnv env, java.net.Socket worker, java.util.concurrent.atomic.AtomicBoolean released, org.apache.spark.TaskContext context)  { throw new RuntimeException(); }
}
