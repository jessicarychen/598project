...
public  class ArrowEvalPythonExec extends org.apache.spark.sql.execution.python.EvalPythonExec implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ArrowEvalPythonExec (scala.collection.Seq<org.apache.spark.sql.execution.python.PythonUDF> udfs, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  private  int batchSize ()  { throw new RuntimeException(); }
  private  java.lang.String sessionLocalTimeZone ()  { throw new RuntimeException(); }
  private  boolean pandasRespectSessionTimeZone ()  { throw new RuntimeException(); }
  protected  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> evaluate (scala.collection.Seq<org.apache.spark.api.python.ChainedPythonFunctions> funcs, int bufferSize, boolean reuseWorker, int[][] argOffsets, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> iter, org.apache.spark.sql.types.StructType schema, org.apache.spark.TaskContext context)  { throw new RuntimeException(); }
}
