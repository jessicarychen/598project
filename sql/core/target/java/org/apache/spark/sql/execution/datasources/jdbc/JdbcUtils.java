...
public  class JdbcUtils {
   ...
   * @param options (undocumented)
   */
  static public  void truncateTable (java.sql.Connection conn, org.apache.spark.sql.execution.datasources.jdbc.JDBCOptions options)  { throw new RuntimeException(); }
