...
public  class FlatMapGroupsWithStateExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.ObjectProducerExec, org.apache.spark.sql.execution.streaming.StateStoreWriter, org.apache.spark.sql.execution.streaming.WatermarkSupport, scala.Product, scala.Serializable {
  ...
  public  class StateStoreUpdater {
     ...
     * @return (undocumented)
     */
    private  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> callFunctionAndUpdateState (org.apache.spark.sql.catalyst.expressions.UnsafeRow keyRow, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> valueRowIter, org.apache.spark.sql.catalyst.expressions.UnsafeRow prevStateRow, boolean hasTimedOut)  { throw new RuntimeException(); }
    /** Returns the state as Java object if defined */
    public  Object getStateObj (org.apache.spark.sql.catalyst.expressions.UnsafeRow stateRow)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression stateDeserializer ()  { throw new RuntimeException(); }
