...
public  class FileSourceScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.DataSourceScanExec, org.apache.spark.sql.execution.ColumnarBatchScan, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   FileSourceScanExec (org.apache.spark.sql.execution.datasources.HadoopFsRelation relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.types.StructType requiredSchema, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> partitionFilters, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> dataFilters, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> tableIdentifier)  { throw new RuntimeException(); }
