...
public  class DataSource implements org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  /**
   * If <code>path</code> is a file pattern, return all the files that match it. Otherwise, return itself.
   * If <code>checkFilesExist</code> is <code>true</code>, also check the file existence.
   * @param hadoopConf (undocumented)
   * @param path (undocumented)
   * @param checkFilesExist (undocumented)
   * @return (undocumented)
   */
  static private  scala.collection.Seq<org.apache.hadoop.fs.Path> checkAndGlobPathIfNecessary (org.apache.hadoop.conf.Configuration hadoopConf, java.lang.String path, boolean checkFilesExist)  { throw new RuntimeException(); }
   ...
   */
  private  org.apache.spark.sql.types.StructType combineInferredAndUserSpecifiedPartitionSchema (org.apache.spark.sql.execution.datasources.FileIndex fileIndex)  { throw new RuntimeException(); }
  /**
