...
public  class DataSourceV2Relation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, org.apache.spark.sql.execution.datasources.v2.DataSourceReaderHolder, scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.execution.datasources.v2.DataSourceV2Relation apply (org.apache.spark.sql.sources.v2.reader.DataSourceReader reader)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   DataSourceV2Relation (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output, org.apache.spark.sql.sources.v2.reader.DataSourceReader reader)  { throw new RuntimeException(); }
