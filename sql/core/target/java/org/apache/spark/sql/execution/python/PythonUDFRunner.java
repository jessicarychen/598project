...
public  class PythonUDFRunner extends org.apache.spark.api.python.BasePythonRunner<byte[], byte[]> {
  ...
  public   PythonUDFRunner (scala.collection.Seq<org.apache.spark.api.python.ChainedPythonFunctions> funcs, int bufferSize, boolean reuseWorker, int evalType, int[][] argOffsets)  { throw new RuntimeException(); }
