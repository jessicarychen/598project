 ...
 */
public  class DataSourceV2ScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.LeafExecNode, org.apache.spark.sql.execution.datasources.v2.DataSourceReaderHolder, org.apache.spark.sql.execution.ColumnarBatchScan, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DataSourceV2ScanExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> output, org.apache.spark.sql.sources.v2.reader.DataSourceReader reader)  { throw new RuntimeException(); }
