...
public  class StateStoreRestoreExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.streaming.StateStoreReader, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   StateStoreRestoreExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> keyExpressions, scala.Option<org.apache.spark.sql.execution.streaming.StatefulOperatorStateInfo> stateInfo, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
